...
<table class="table table-bordered table-striped table-hover">
	<tbody>
		...
		<tr>
			<td>
				<label for="given_name"><?php echo JText::_('COM_KUNENA_GIVENNAME'); ?></label>
			</td>
			<td>
				<input class="required" type="text" id="given_name" name="given_name"
				       value="<?php echo $this->escape($this->user->get('given_name')); ?>" size="40" />
			</td>
		</tr>
		<tr>
		<tr>
